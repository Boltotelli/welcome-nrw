...
async function renderCrownLive(){
 ...
 try{
  ...
  v.innerHTML='<div class="hero"><div><div class="kicker">CROWN · LIVE</div><h1>'+E(crownLang2.title)+'</h1><p>'+E(crownLang2.privacy)+'</p></div><div class="hero-actions"><span class="pill gold">Königsallianz · '+E(k.alliance_code||'–')+'</span></div></div>'+
   (d?.has_access?'<div class="live-stat-grid"><div class="live-stat"><b>'+rows.length+'</b><small>aktive Minister-Sperren</small></div><div class="live-stat"><b>'+recent.length+'</b><small>beendet · 24h</small></div><div class="live-stat"><b>'+E(k.name||'–')+'</b><small>König</small></div><div class="live-stat"><b>'+E(D(k.refreshed_at))+'</b><small>aktualisiert</small></div></div>':'<div class="live-stat-grid"><div class="live-stat"><b>'+E(k.alliance_code||'–')+'</b><small>Königsallianz</small></div><div class="live-stat"><b>'+E(k.name||crownLang2.king)+'</b><small>König</small></div><div class="live-stat"><b>'+E(D(k.refreshed_at))+'</b><small>aktualisiert</small></div></div>')+
