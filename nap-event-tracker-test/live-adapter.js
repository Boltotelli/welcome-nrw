...
function paintActivity2(){
 const v=document.getElementById('view-activity');if(!v)return;const types=[['all','Alle'],['uploads','Uploads'],['players','Spieler'],['events','Events'],['violations','Verstöße'],['deleted','Gelöscht']],rows=(S.activity||[]).filter(a=>activityType2==='all'||activityCategory2(a)===activityType2);
